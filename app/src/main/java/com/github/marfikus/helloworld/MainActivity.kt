    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val confidentialClickable = object : ClickableSpan() {
            override fun onClick(widget: View) {
                Snackbar.make(widget, getString(R.string.go_to_link_1), Snackbar.LENGTH_SHORT).show()
            }
        ...
        val policyClickable = object : ClickableSpan() {
            override fun onClick(widget: View) {
                Snackbar.make(widget, getString(R.string.go_to_link_2), Snackbar.LENGTH_SHORT).show()
            }
